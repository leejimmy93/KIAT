...
system.time(MBASED.F1.414.vs.F1.415 <- TwoSample(annotatedData, mySNVs, "F1_414", "F1_415"))

save(MBASED.F1.414.vs.F1.415, file = "/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/F1_SNP/ASE/MBASED.F1.414.vs.F1.415.Rdata")


save(MBASED.F1.414, file = "/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/F1_SNP/ASE/MBASED.F1.414.1000000.Rdata")
