...
=======
### the Ae allele ratio should follow beta-binomial distribution, with prior as the average for null, and update with the Ae allele ratio in each of the observed SNPs for a gene, and calculate the posterior distribution for different genes??? 
http://genome.cshlp.org/content/21/10/1728.long 
>>>>>>> dc2c4dbd0a5d0ef4639837db846d8200d5c76ef7
```
Yes, we understand!
...
```{r}
gene2 <- F1.counts.long %>% filter(gene_ID=="BnaA01g00030D")
