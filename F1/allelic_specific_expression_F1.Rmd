...
cat(DEGs_allele_count, "DEGs have allele count, among" SNP_number, "loci with allele count", SNP_ASE_414, "and" SNP_ASE_415, "show allele specific expression in 414F1 and 415F1 respecitively \n")
...
for SNP/loci that show ASE (deviated from binomial distribution), how many of them have paternal-origin-specific expression? Are SNPs in the same gene show the same direction? (ie. all have paternal-orginal-specific expression pattern?) 
```{r}
# BTvalue < 0.05, 
