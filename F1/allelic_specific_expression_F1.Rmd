...
ggplot(data = F1.young.GQ.filtered) + geom_histogram(aes(x=(F1.young.GQ.filtered$F1_415_RO/F1.young.GQ.filtered$F1_415_AO+F1.young.GQ.filtered$F1_415_RO))) + labs(x="genotype quality of 415", y="Number of SNPs") 

F1.young.GQ.filtered$F1_415_RO/F1.young.GQ.filtered$F1_415_AO+F1.young.GQ.filtered$F1_415_RO
F1.young.GQ.filtered$F1_415_RO 
F1.young.GQ.filtered$F1_415_GT  
```
