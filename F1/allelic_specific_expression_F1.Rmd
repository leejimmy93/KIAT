...
```{r}
gene2 <- F1.counts.long %>% filter(gene_ID=="BnaA01g00050D")
...
# 1) is there cross effect for each gene? i.e. Ae.counts is affected by the kind of cross, which might affect the expression level of those genes between the two kinds of crosses. 
# all on cabernet 
```
