...
# TODO: Figure out how to calculate dispersion
CalcDispersion <- function(vcf, genotype) {
  return(0)
}
```
...
refBias414 <- CalcReferenceBias(inputVCF, "F1_414") # 0.5107107
refBias415 <- CalcReferenceBias(inputVCF, "F1_415") # 0.5152294
