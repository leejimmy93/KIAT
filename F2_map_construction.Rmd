...
maps <- list(LG.f2.A01.force, LG.f2.A02.force, LG.f2.A03.force, LG.f2.A04.force, LG.f2.A05.force, LG.f2.A06.force, LG.f2.A07.force, LG.f2.A08.force, LG.f2.A09.force, LG.f2.A10.force)
draw.map(maps, names= F, grid=F, cex.mrk=0.5, cex.grp=0.75, horizontal = T) 

write.map(maps, "~/Desktop/Brassica_project/KIAT_RNA_seq/F2/output/map.onemap.1st.map")
```
...
# import data 
```{r}
map.F2 <- read.cross("mm", file = "~/Desktop/Brassica_project/KIAT_RNA_seq/F2/output/missing_rate_0.15/right/F2_geno_for_one_map_final.txt", mapfile = "~/Desktop/Brassica_project/KIAT_RNA_seq/F2/output/map.onemap.1st.map")
