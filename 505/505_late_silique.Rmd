...
write.csv(SNP_gene_final_fxn, file = "~/505/output/131_sample/GWAS_SNP_gene_fxn_het.csv")
...
# analyze snpEff annotation file 
# cat GWAS_SNP_gene_fxn_het.csv | sed 's/"//g' | sed 's/,/ /g' | awk '{print $3}' | tail -${number_of_SNP} > significant_SNP
