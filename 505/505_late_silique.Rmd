...
dim(SNP.Erucic.Oleic.unique) # 259 2 
...
write.csv(SNP_gene_final_fxn, file = "~/Desktop/Brassica_project/KIAT_RNA_seq/505/output/late_silique/GWAS_SNP_gene_fxn.csv")

# as a summary, 219 out of the 259 SNPs fall within genes, 201 of them have arabidopsis homologs.
``` 
...
# grep -f significant_SNP_219 /Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/505/vcf_late_silique_131_sample/combined/505_filtered_sorted_ann.vcf | awk '{print $3 "|" $4 "|" $5 "|" $8}' | awk 'BEGIN{FS="|"}{print $1, $2, $3, $5}' > significant_SNP_219_annotation 

sig_SNP_ann <- read_table2("~/505/output/131_sample/significant_SNP_219_annotation", col_names=F)
head(sig_SNP_ann)  
colnames(sig_SNP_ann) <- c("snp_ID", "ref", "alt", "mutation_type")

unique(sig_SNP_ann$X4)
# [1] "missense_variant"                         "stop_gained"                             
# [3] "upstream_gene_variant"                    "synonymous_variant"                      
# [5] "splice_region_variant&synonymous_variant" "downstream_gene_variant"                 
# [7] "splice_region_variant&intron_variant"     "stop_lost"                               
# [9] "stop_gained&splice_region_variant"        "stop_retained_variant"                   
# [11] "intron_variant"                          
...
```{r}
# add expressions? most of them will be differentially expressed 
```
...
>>>>>>> 5d68b4db960788d08dd9574a974c1cb88a0d251e
```
