...
Erucic_acid <- read.csv("~/505/output/myGAPIT/late_silique_131_sample_SN/GAPIT..Erucic_acid.GWAS.Results.csv", header = T)

Oil_content <- read.csv("~/505/output/myGAPIT/late_silique_131_sample_SN/GAPIT..Oil_content.GWAS.Results.csv", header = T)

Oleic_acid <- read.csv("~/505/output/myGAPIT/late_silique_131_sample_SN/GAPIT..Oleic_acid.GWAS.Results.csv", header = T)

colnames(Erucic_acid)[1:4] <- c("SNP", "CHR", "BP", "P")
colnames(Oil_content)[1:4] <- c("SNP", "CHR", "BP", "P")
colnames(Oleic_acid)[1:4] <- c("SNP", "CHR", "BP", "P")

png("~/505/output/figure/131_sample_SN.png", width=12, height=10, units="in", res=300)
par(mfrow=c(3,1)) 
manhattan(Erucic_acid, main = "Erucic acid", ylim = c(0, 8), cex = 0.6, 
          cex.axis = 0.9, col = c("blue4", "orange3"), supggestiveline = 5, genomewideline = F 
) 
