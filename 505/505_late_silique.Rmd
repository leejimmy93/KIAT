...
```{r}
# sample description 
sample_des_f <- read.csv("~/Desktop/Brassica_project/KIAT_RNA_seq/505/data/batch_f.csv", header = T) 
...
sum(!is.na((rbind(sample_des_c_sub, sample_des_d_sub, sample_des_e_sub))[,"TotalReads"]))
