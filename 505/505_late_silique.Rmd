...
# cat SNP.ID.het.filterd.txt | sed 's/"//g' | grep -v "Chromosome" | awk '{print "chr"$2 "\t" $3}' > SNP.ID.het.filterd 
...
# run_pipeline.pl -Xmx5g -fork1 -vcf 505_filtered_het.recode.vcf_sorted.vcf -export -exportType Hapmap -runfork1  
