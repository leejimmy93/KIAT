...
# only look at A08 and C03
SNP_RNA_2 <- 
SNP_RNA %>% 
  filter(chrom == "A08" | chrom == "C03")

SNP_WGS_2 <- read.table("~/505/WGS/vcf_filtered/two_options/  /chrA08_het_0.2.hmp.txt", header = T, stringsAsFactors = F)
...
dim(common_WGS_RNA_2) # 391 142 # 1151 common SNPs between C03 BWA for RNA & WGS data  # 1393 SNPs common between STAR RNA & WGS data A08    
