...
```{r}
# WGS 
WGS_K4 <- read.table("/home/ubuntu/distruct1.1/WGS_K4.outfile")
...
write.table(WGS_K4_popq, file ="/home/ubuntu/distruct1.1/WGS_K4_popq", row.names = FALSE, 
            col.names = FALSE, sep = "\t", quote = FALSE)

write.table(WGS_K4, file ="/home/ubuntu/distruct1.1/WGS_K4_indivq", row.names = FALSE, 
            col.names = FALSE, sep = "\t", quote = FALSE)
