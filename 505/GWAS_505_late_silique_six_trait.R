...
setwd("/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/505/output/myGAPIT/late_silique_131_sample/six_traits")
...
# phenotype data 
load("~/505/genomic_prediction/data/pheno.505.six.Rdata")
