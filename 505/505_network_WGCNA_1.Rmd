...
png(filename = "~/505/network_analysis/output/figure/trait_hist1.png",width=220, height=200, units="mm", res=300)
par(mfrow=c(5, 4))
...
png(filename = "~/505/network_analysis/output/figure/trait_hist2.png",width=220, height=200, units="mm", res=300)
par(mfrow=c(5, 4))
...
png(filename = "~/505/network_analysis/output/figure/trait_hist3.png",width=220, height=200, units="mm", res=300)
par(mfrow=c(5, 4)) 
