...
rownames(vstMat.505.batch.corrected.largeVar) <- 
  rownames(vstMat.505.batch.corrected[vstMat.505.batch.corrected$CV >15,]) # keep the last quantile & make sure include the two FAE1 genes "BnaA08g11130D" & "BnaC03g65980D"
...
# p.mds.country.2 <- p.mds.country.2 + scale_color_brewer(type="qual",palette="Set1")
  ...
  theme(legend.position = c(0.9, 0.2), legend.background = element_rect(fill="lightgrey", size=0.5, linetype="solid"), axis.title.x=element_blank(), axis.title.y =element_blank()) + 
