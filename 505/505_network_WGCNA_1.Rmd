...
rownames(vstMat.505.batch.corrected.largeVar) <- 
  rownames(vstMat.505.batch.corrected[vstMat.505.batch.corrected$variance >1,])
...
MEs.signed <- MEs
save(moduleColors, MEs.signed, file = "~/505/network_analysis/output/MEs_505_signed.Rdata")
``` 
...
# check "brown4" module 
vstMat.505.brown4 <- 
  vstMat.505.batch.corrected.largeVar[moduleColors == "brown4",] %>% 
  t() %>% as.data.frame()
...
pheatmap(as.matrix(t(vstMat.505.brown4)),  
