...
setwd("/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/505/output/myGAPIT/late_silique_131_sample/bolting_floweirng_fruition_oil")
...
# phenotype data 
load("~/505/genomic_prediction/data/pheno_data_505_bolting_flowering_fruition_oil.Rdata")
