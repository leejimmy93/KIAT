...
setwd("/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/505/output/myGAPIT/sig_leaf_other_silique")

######### load data
# genotype data 
geno_505_hmp <- read.table("~/505/leaf_VS_late_silique/sig_leaf_other_silique.hmp.txt", head=FALSE)
