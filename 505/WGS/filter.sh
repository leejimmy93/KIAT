...
for i in $chrom
	do 
	echo $i
	vcftools --gzvcf ${i}.vcf.gz --remove-indels --min-alleles 2 --max-alleles 2 --maf 0.05 --minQ 40 --minGQ 30 --min-meanDP 0 --max-meanDP 500 --max-missing 0.2 --recode --recode-INFO-all --out ${outdir}/${i}_filtered
