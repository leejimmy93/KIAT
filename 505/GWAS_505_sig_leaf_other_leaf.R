...
setwd("/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/505/output/myGAPIT/sig_leaf_other_leaf")

######### load data
# genotype data 
geno_505_hmp <- read.table("~/505/leaf_VS_late_silique/sig_leaf_other_leaf.hmp.txt", head=FALSE)
