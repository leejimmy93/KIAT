...
# sam to bam transformation & sorting bam file have been added to run_star.sh 

# --> to do: use cufflinks for assembly 
# cufflinks -o output/ --library-type ff-firststrand test.sorted
# cufflinks -o output2/ --library-type ff-secondstrand test.sorted
# cufflinks -o output3/ --library-type fr-firststrand test.sorted
# cufflinks -o output4/ --library-type fr-secondstrand test.sorted 
