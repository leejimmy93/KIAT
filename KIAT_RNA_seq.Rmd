...
# STAR --genomeDir /Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/Reference/B.napus/star_genome --readFilesIn ../Ae_1.fq ../Ae_2.fq --runThreadN 6 --outSAMtype BAM SortedByCoordinate (screen -r 15587.extract_1000 running now) 

# STAR --genomeDir /Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/Reference/B.napus/star_genome --readFilesIn ../Ol_1.fq ../Ol_2.fq --runThreadN 6 --outSAMtype BAM SortedByCoordinate (screen -r 14264.fastqc running now)  
...
topTags(lrt.young)
summary(de.young <- decideTestsDGE(lrt.young, p=0.075))
DEgene.young <- topTags(lrt.young,n = Inf)$table[topTags(lrt.young,n = Inf)$table$FDR<0.075,]
# -1  4553
# 0  51999
# 1   4423
...
summary(de.flowering <- decideTestsDGE(lrt.flowering, p=0.075))
DEgene.flowering <- topTags(lrt.flowering,n = Inf)$table[topTags(lrt.flowering,n = Inf)$table$FDR<0.075,]
# -1  2877
# 0  54894
# 1   3204
...
summary(de.early.silique <- decideTestsDGE(lrt.early.silique, p=0.075))
DEgene.early.silique <- topTags(lrt.early.silique,n = Inf)$table[topTags(lrt.early.silique,n = Inf)$table$FDR<0.075,]
# -1  3200
# 0  54280
# 1   3495
...
summary(de.late.silique <- decideTestsDGE(lrt.late.silique, p=0.075))
DEgene.late.silique <- topTags(lrt.late.silique,n = Inf)$table[topTags(lrt.late.silique,n = Inf)$table$FDR<0.075,]
# -1  3745
# 0  53562
# 1   3668
...
topTags(lrt.bolting)
summary(de.bolting <- decideTestsDGE(lrt.bolting, p=0.075))
DEgene.bolting <- topTags(lrt.bolting,n = Inf)$table[topTags(lrt.bolting,n = Inf)$table$FDR<0.075,]
# -1  2794
# 0  56327
# 1   1854
