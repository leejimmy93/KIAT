...
# bamaddrg -b Ae_paired.star.trim.dir/Ae_rmdup.bam -s Ae -r Ae -b Ol_paired.star.trim.dir/Ol_rmdup.bam -s Ol -r Ol | freebayes --fasta-reference /Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/Reference/B.napus/Brassica_napus_v4.1.chromosomes.fa --stdin --ploidy 4 --min-alternate-count 4 --min-alternate-fraction 0.4 > Ae_Ol.vcf
...
## remapping the new data using STAR ... ing 
