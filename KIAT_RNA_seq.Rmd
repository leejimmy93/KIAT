...
summary(de.flowering.vs.early.silique <- decideTestsDGE(lrt.flowering.vs.early.silique.ae, p=0.05))
...
fatty.acid.genes.interaction <- fatty.acid.genes[c("BnaA03g41660D","BnaA05g06830D","BnaC07g32730D"),]

# reformat for ggplot 
fatty.acid.genes.interaction <- fatty.acid.genes.interaction[,-28]
...
ggsave("/Users/ruijuanli/Desktop/Brassica_project/KIAT_RNA_seq/figure/F1/fatty.acid.interaction.png", width = 8, height = 4)
