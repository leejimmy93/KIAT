...
ggsave(p.average.HQ, filename =  "~/Desktop/Brassica_project/KIAT_RNA_seq/parent_SNP/output/figure/average_HQ.png", height = 6, width = 2) 
...
ggsave(p.average.mapping, filename =  "~/Desktop/Brassica_project/KIAT_RNA_seq/parent_SNP/output/figure/average_mapping.png", height = 6, width = 7) 
```
...
### Cap3 to remove redundant sequences (isoforms)
# run_cap.sh 
# https://github.com/leejimmy93/KIAT_whitney/blob/master/parent_RNA_transcriptome/run_cap3.sh

# concatenate contig and singletons from cap3 
# cat Ae.u.fa.cap.contigs Ae.u.fa.cap.singlets > Ae.u.fa.cap.contigs_singlets
# cat Ol.u.fa.cap.contigs Ol.u.fa.cap.singlets > Ol.u.fa.cap.contigs_singlets 

# no need to blastn against rapa ref CDS because those are with other class code 

# steps needed as pipline: get transcripts with ORF  
# TransDecoder.LongOrfs -t ../../cap3/Ae.u.fa.cap.contigs_singlets
# TransDecoder.LongOrfs -t ../../cap3/Ol.u.fa.cap.contigs_singlets

# steps needed as stats check: blast against nr database to see how many have plant hit how many don't have plant hit or don't have hit at all... 
# blast_nr.sh 
# https://github.com/leejimmy93/KIAT_whitney/blob/master/parent_RNA_transcriptome/blast_nr.sh

### note: need to remove redundancy when combined with de-novo transcripts & remove isoforms... 

# To do: combine with de-novo transcripts for PASA annotation ... at this moment learn PASA for annotation with reference based assembly only... 
...
####################### This can be done after reduant sequences are removed ################## 
