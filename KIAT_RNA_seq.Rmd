...
# STAR --runMode genomeGenerate --genomeDir star_genome/ --genomeFastaFiles Brassica_napus_v4.1.chromosomes.fa --sjdbGTFfile Brassica_napus.annotation_v5.gtf --runThreadN 6 
...
# screen -r 9837.ttys004.coloma (core dumped) 
# screen -r 9867.ttys004.coloma (done) 
...
# 1.3) if the top hit of for the two files are the same, write out the result, a python script 
