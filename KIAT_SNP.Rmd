...
sum(vcf.freebayes.HQ.1.Ae.het$Ae_alt.depth==0)
...
pl.allele.ratio.Ae.orginal <- function(vcf.subset){
  ...
  pl <- pl + geom_histogram(aes(x=tmp)) 
  pl <- pl + geom_histogram(aes(Ae_alt.depth/Ae_ref.depth)) 
  pl <- pl +labs(list(x="(alt.depth/ref.depth)"))  + xlim(0,3)
  return(pl)  
}   
  
allele.ratio.Ae.het <- pl.allele.ratio.Ae.orginal(vcf.freebayes.HQ.1)
allele.ratio <- pl.allele.ratio.Ae.orginal(vcf.freebayes.HQ.1.Ae.het)
