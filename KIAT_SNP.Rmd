...
vcf.freebayes.HQ.1 <- vcf.freebayes.HQ[(!is.na(vcf.freebayes.HQ$Ae_tot.depth) & 
                              ...
                              vcf.freebayes.HQ$Ae_tot.depth > 5 & 
                              vcf.freebayes.HQ$Ol_tot.depth > 5 & 
                              vcf.freebayes.HQ$Ae_tot.depth < 200 & 
                              vcf.freebayes.HQ$Ol_tot.depth < 200),]
dim(vcf.freebayes.HQ.1) # 18823    21
...
# samtools view ../alignment_freebayes/Ae_paired.star.trim.dir/Aligned.sortedByCoord.out.bam | awk '$5 == "255"' > Ae_unique_mapped.sam 
# samtools view ../alignment_freebayes/Ol_paired.star.trim.dir/Aligned.sortedByCoord.out.bam | awk '$5 == "255"' > Ol_unique_mapped.sam
...
# now rerun GATK SNP calling pipeline using no bolting data 
```{r}
# /Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/KIAT_whitney/KIAT_whitney/parent_SNP/SNP_calling_GATK_pipeline.sh 
```

# data directory 
```{r}
# unfiltered & filtered SNPs from GATK on cabernet are stored under the directory of /share/malooflab/Ruijuan/parent_SNP/SNP_calling/GATK/output 
# named as ${sample}.vcf & ${sample}.filtered.vcf 
```
