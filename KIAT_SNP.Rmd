...
### How to export data to vcf format 
dim(vcf.Ae.Ol.no.bolting.unique) # 
write.table(vcf.Ae.Ol.no.bolting.unique, file = "~/Desktop/Brassica_project/KIAT_RNA_seq/SNP_calling/output/test_content.txt")
