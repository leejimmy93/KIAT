...
test.2.F2.Y <- SNP.reform(F2.Y) # randomly pick 96 
seq.final.F2.Y <- get.fasta(test.2.F2.Y, napus) # get fasta seq for the 96 SNPs
...
writeXStringSet(seq.final.F2, filepath = "~/Desktop/Brassica_project/KIAT_RNA_seq/parent_SNP/output/seq.final.F2.fa")
