...
vcf.GATK.A01.biallelic <- read.table("~/Desktop/Brassica_project/KIAT_RNA_seq/parent_SNP/data/GATK/as_diploid/no_bolting/xab.intervals.vcf.filtered.SNP.biallelic.recode.vcf",as.is=T,na.strings = ".") 
