...
####### gene correlation with MAF (non uniform format make this not easy...)
...
# quick test of the intersect between freebayes & 
# vcf.freebayes.test <- paste(vcf.freebayes.HQ.1.reform$CHROM, vcf.freebayes.HQ.1.reform$POS, sep = "_")
# vcf.GATK.test <- paste(vcf.GATK.HQ.2.reform$CHROM, vcf.GATK.HQ.2.reform$POS, sep = "_") 
# length(intersect(vcf.freebayes.test, vcf.GATK.test)) # 170670 same SNP positions between freebayes & GATK 
