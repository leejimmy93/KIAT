...
all.revised <- paste(all$CHROM, all$POS, sep = "_")

# randomly sample data... 
set.seed(1) 
test <- sample(all.revised, size = 96, replace = F)
test
...
test.2$start <- as.numeric(as.character(test.2$POS))-150
...
for (i in 1:length(napus)){
 test.i <- test.2[test.2$CHROM == names(napus)[i],]
...
writeXStringSet(seq.final, filepath = "~/Desktop/Brassica_project/KIAT_RNA_seq/parent_SNP/output/seq.final.fa")
