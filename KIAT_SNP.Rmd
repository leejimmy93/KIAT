...
# SNP calling   
```{r}
# 1) remove PCR duplicate, add read group & freebayes 
...
dim(vcf.freebayes.HQ) # 1133952      25 
nrow(vcf.freebayes.HQ) / nrow(vcf.freebayes.reform) # 91% of SNPs were retained with QUAL > 40
...
vcf.GATK.A01.biallelic <- read.table("~/Desktop/Brassica_project/KIAT_RNA_seq/parent_SNP/data/GATK/as_diploid/filtered/xaa_biallelic.reformat.vcf",as.is=T,na.strings = ".") 

head(vcf.GATK.A01.biallelic, 100) 
vcf.header.GATK <- system("grep '#C' ~/Desktop/Brassica_project/KIAT_RNA_seq/parent_SNP/data/GATK/as_diploid/filtered/xaa_biallelic.reformat.vcf",intern = TRUE) 
...
vcf.GATK.HQ.1 <- vcf.GATK.HQ[(!is.na(vcf.GATK.HQ$Ae_approx.depth) & 
                              ...
                              vcf.GATK.HQ$Ae_approx.depth > 5 & 
                              vcf.GATK.HQ$Ol_approx.depth > 5 & 
...
vcf.GATK.HQ$Ae_genotype.qual
vcf.GATK.HQ$Ol_genotype.qual
...
vcf.GATK.reform.HQ.filtered.Ol.het <- vcf.GATK.reform.HQ.filtered[(vcf.GATK.reform.HQ.filtered$Ol_gt=="0/1"),]
