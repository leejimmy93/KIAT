...
# SNP calling   
```{r}
# remove PCR duplicate, add read group & freebayes 
...
vcf.freebayes <- read.table("~/Desktop/Brassica_project/KIAT_RNA_seq/parent_SNP/data/freebayes/as_diploid/no_bolting_unique_mapped/Ae_Ol_modified.vcf",as.is=T,na.strings = ".") 
dim(vcf.freebayes) # 1241165      11 
...
dim(vcf.freebayes.reform) # 1241165      11  
