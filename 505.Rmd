...
p.mds.country <- ggplot(data=geno.mds.all.des, aes(V1, V2, color=factor(Sample.Description.Origin),label=factor(Sample.Description.Origin)))
p.mds.country <- p.mds.country + geom_point(size=1) + geom_text(size=4)
