...
geno_505_hmp <- read.table("~/505/vcf_leaf_no_pop/combined/505_filtered_GQ_sorted.hmp.txt", head=T)
...
pheno_data_505 <- gh.seed.bolt.table.wide[gh.seed.bolt.table.wide$SN %in% colnames(geno_505_hmp.for.GWAS)[12:105] ,] 
...
geno_505_hmp.for.GWAS.nomissing <- geno_505_hmp.for.GWAS[,!(colnames(geno_505_hmp.for.GWAS) %in% filter)]
head(geno_505_hmp.for.GWAS.nomissing)
tail(geno_505_hmp.for.GWAS.nomissing)
...
geno_505_hmp.for.GWAS.nomissing.final[1:10, 1:10]
