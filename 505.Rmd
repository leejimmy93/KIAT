...
```{r}
library("qqman")
Erucic_acid <- read.csv("~/Desktop/Brassica_project/KIAT_RNA_seq/505/output/myGAPIT/A01/GAPIT..Erucic_acid.GWAS.Results.csv", header = T)

Oil_content <- read.csv("~/Desktop/Brassica_project/KIAT_RNA_seq/505/output/myGAPIT/A01/GAPIT..Oil_content.GWAS.Results.csv", header = T)

Oleic_acid <- read.csv("~/Desktop/Brassica_project/KIAT_RNA_seq/505/output/myGAPIT/A01/GAPIT..Oleic_acid.GWAS.Results.csv", header = T)
...
par(mfrow=c(3,1)) 
png("~/Desktop/Brassica_project/KIAT_RNA_seq/505/output/figure/GWAS_preliminary.png", width=4, height=3, units="in", res=300)

manhattan(Erucic_acid, main = "Erucic acid", ylim = c(0, 5), cex = 0.6, 
    cex.axis = 0.9, supggestiveline = 3, genomewideline = F 
    ) 

manhattan(Oil_content, main = "Oil content", ylim = c(0, 5), cex = 0.6, 
    cex.axis = 0.9, suggestiveline = 3, genomewideline = F
    ) 

manhattan(Oleic_acid, main = "Oleic acid", ylim = c(0, 5), cex = 0.6, 
    cex.axis = 0.9, suggestiveline = 3, genomewideline = F 
    ) 

dev.off() 
=======
# display GWAS result using qqman 
```{r}
install.packages("qqman")
library("qqman") 

### memory problem... 
>>>>>>> 6cdb4a60fc0fe14475c38adf299747f3ae0bd982
