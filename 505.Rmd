...
gh.seed.bolt.table.wide.merge.t <- data.frame(t(gh.seed.bolt.table.wide.merge))
head(gh.seed.bolt.table.wide.merge.t)
colnames(gh.seed.bolt.table.wide.merge.t) <- gh.seed.bolt.table.wide.merge$Sample.ID
