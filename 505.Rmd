...
colnames(pheno_data_505) <- pheno_data_505[,c("SN", "FATTY ACID_Erucic acid (C22:1n9)", "FATTY ACID_oil contents (%)", "FATTY ACID_Oleic acid (C18:1n9c)")]
          
colnames(pheno_data_505) <- c("taxa", "erucic_acid", "oil_content", "oleic_acid")
head(pheno_data_505) 
rownames(pheno_data_505) <- c(1: nrow(pheno_data_505))

myY <- pheno_data_505
myG <- geno_505_hmp.for.GWAS
