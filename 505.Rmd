...
lrt.read.count <- glmLRT(fit.read.count, coef=2:94) 
topTags(lrt.read.count)
FDR <- p.adjust(lrt.read.count$table$PValue, method="fdr")

## pull out the TMM normalized expression value for the 24 genes 
