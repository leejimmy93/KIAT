...
length(vcf.F1$QUAL) # a total of 21002031 SNPs 
sum(vcf.F1$QUAL>20) / length(vcf.F1$QUAL) # 78.5% are above QUAL score of 20, which means less than 0.01 probability that it isn't polymorphic 
