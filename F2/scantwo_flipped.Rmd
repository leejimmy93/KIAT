...
# FAE1_data$chrA03_12781099 <- relevel(FAE1_data$chrA03_12781099, ref = "A") 
# FAE1_data$chrA08_10120555 <- relevel(FAE1_data$chrA08_10120555, ref = "A") 
# FAE1_data$chrC03_53442609 <- relevel(FAE1_data$chrC03_53442609, ref = "A") 
summary(FAE1_data)
...
waic(FAE1,FAE1.2, FAE1.3, FAE1.4)
loo(FAE1,FAE1.2, FAE1.3, FAE1.4)
loo(FAE1,FAE1.2.2, FAE1.2.3)
waic(FAE1,FAE1.2.2, FAE1.2.3)  
...
FAE0 <- brm(Erucic_acid ~ chrC03_53442609 + chrA08_10120555,
            data = FAE1_data, 
            prior = set_prior("normal(0,10)",class="b"))  # mean of 0 and sd of 10

### hypothesis testing 
# A08 & C03, no interaction 
summary(FAE0) 
hypothesis(FAE0, "chrA08_10120555B < 0")
hypothesis(FAE0, "chrC03_53442609B < 0")  

# only A08 & C03
summary(FAE1)
hypothesis(FAE1, "chrA08_10120555B < 0")
hypothesis(FAE1, "chrC03_53442609B < 0")  

loo(FAE1,FAE0)

# add A03
summary(FAE1.2)
hypothesis(FAE1.2, "chrA08_10120555B < 0") 
hypothesis(FAE1.2, "chrC03_53442609B < 0") 
hypothesis(FAE1.2, "chrA03_12781099B > 0")

# add A03, no interaction 
summary(FAE1.2.2) 
hypothesis(FAE1.2.2, "chrA08_10120555B < 0") 
hypothesis(FAE1.2.2, "chrC03_53442609B < 0") 
hypothesis(FAE1.2.2, "chrA03_12781099B > 0")  ### allele from Da-Ol-1 increase Erucic acid level. 
plot(hypothesis(FAE1.2.2, "chrA03_12781099B > 0"))  
summary(FAE1.2.2)

# add A03, and include interaction between A08 and C03
summary(FAE1.2.3)
hypothesis(FAE1.2.3, "chrA08_10120555B < 0") 
hypothesis(FAE1.2.3, "chrC03_53442609B < 0") 
hypothesis(FAE1.2.3, "chrA03_12781099B > 0")  ### allele from Da-Ol-1 increase Erucic acid level. 
plot(hypothesis(FAE1.2.2, "chrA03_12781099B > 0")) 
