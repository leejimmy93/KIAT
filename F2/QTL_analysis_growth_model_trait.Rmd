...
save(growth_modelQTL.annotated, file = "~/F2/output/growth_model/growth_modelQTL.annotated.Rdata") 
...
cis_eQTL.qtl.combined %>% dim() # 488   18 
...
trans_eQTL.qtl.combined %>% dim() # 265    18 
...
write.csv(cis_eQTL.qtl.combined.final, file = "~/F2/output/growth_model/cis_eQTL.qtl.combined.final.model.csv")

write.csv(trans_eQTL.qtl.combined.final, file = "~/F2/output/growth_model/trans_eQTL.qtl.combined.final.model.csv") 

save(cis_eQTL.qtl.combined.final, trans_eQTL.qtl.combined.final, file = "~/F2/output/growth_model/eQTL.qtl.combined.final.model.Rdata")  
```
...
=======
>>>>>>> 088f1a36da73d1d89e7d20128db1a8c1824af92a
