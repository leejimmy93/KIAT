...
twopts.f2.LOD3_rf0.4 <- rf.2pts(F2.data, LOD = 3, max.rf = 0.4)

# save & export data 
save(twopts.f2.LOD3_rf0.4, file='/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/F2/output/missing_rate_0.10/twopts.LOD3_rf0.4.Rdata')
