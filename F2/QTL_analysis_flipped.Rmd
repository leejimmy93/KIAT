...
traitQTL.annotated %>% 
  ...
  dplyr::select(trait, SNP.ID, mutation_type, impact, gene_ID, AGI, At_symbol, B.napus_GO_term, GO_des, chrom, Ae.gt, Ol.gt) 
...
traitQTL.annotated.SNP %>% 
  filter(gene_ID == "BnaA01g03770D" | gene_ID == "BnaA01g07910D" | gene_ID == "BnaA03g37760D" | gene_ID == "BnaA08g07360D" | gene_ID == "BnaA08g07670D" | gene_ID == "BnaA08g11140D" | gene_ID == "BnaC03g51320D") %>% 
  View()
