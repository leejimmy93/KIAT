...
ggsave(p.flower_etc, filename = "~/F2/for_paper/flower_etc.png", height = 70, width = 188, dpi = 300, units = "mm")
ggsave(p.final_FA, filename = "~/F2/for_paper/FA.png", height = 70, width = 188, dpi = 300, units = "mm")  
```
