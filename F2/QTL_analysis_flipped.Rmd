...
test <- scanone(LG.f2.after.crossover, pheno.col = "Caprylic_acid", method = "imp", upper = F)

# permutation 
perm_Caprylic <- 
scanone(LG.f2.after.crossover, pheno.col = "Caprylic_acid", method = "em", model = "2part", upper = F, n.perm = 1000)

summary(perm_Caprylic)[1] 
...
perm_Heptadecanoic <- summary(perm_Heptadecanoic)[1] 
perm_Myristic
perm_Caprylic
...
### 
permtest.F2.new <- list()
alphas <- seq(0.01, 0.10, by = 0.01) 
lod.thrs <- summary(perm_Caprylic, alphas) 
lod.thrs  

plot(scanone_Heptadecanoic_new[,c(1,2,4)])
scanone_Heptadecanoic_new %>% head()
dev.off()

### this needs more time... come back later ... 
```
