...
blast_result <- read.delim(file = "~/F2/for_paper/linolenic_acid/reciprocal.blast_eQTL", header = F)
blast_result
...
homeo_blast
cis_eQTL_linolenic <- allele_effect_result[allele_effect_result$names %in% homeo_blast,]

# combine with SNP result to look for potential candidates ... 

>>>>>>> 6f90f3a26bd4b76785fc075f390a6fb06c47647f
```
