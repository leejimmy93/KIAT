...
# check the allele effect for all genes? not filtering for homeologous pair
system.time(
test.all <-   
...
########## run till here for all 217 genes 
# next, check result to see whether there are negative effect  
names(test.all) <- cis_eQTL.qtl.combined.final.linolenic$gene_ID

allele_effect_result <- sapply(names(test.all), function(gene) test.all[[gene]]$ests[2,1])
allele_effect_result ## all possible genes have positive allele effect from Da-Ol-1 
