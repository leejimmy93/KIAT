...
blups.F2$line <- rownames(blups.F2.A)
MEs$line 
...
png(filename = "~/F2/output/network_analysis/Module-trait_heatmap_F2_batch_corrected.png",width=20, height=16, units="in", res=300)
par(mar = c(8, 5, 3, 3)); 
...
test <- c("BnaC03g65980D", "BnaC03g66040D", "BnaC03g62710D", "BnaC03g65690D", "BnaC03g65910D", "BnaC03g65700D")
