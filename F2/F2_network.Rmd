...
<<<<<<< HEAD
=======
# one thing I need to figure out, what is the individual's name in the map... so that later on when I load data for R/qtl, I don't need to reformat everything... 
>>>>>>> 8bd678e2ecd5fb264f7e81c91e293f08f6be52b3
>>>>>>> f06fcddce5734a7d5dc54d214d1782e5e27bcaa5
...
The goal is to find QTL peaks for the WGCNA eigen genes and see if those overalp with any traitß QTL. We are only focusing on eigen genes that correlated with some growth traits/paramters. 
...
pl.CR  
ggsave("~/F2/output/network_analysis/eigen gene eQTL CR.pdf",width=12,height=8) 
