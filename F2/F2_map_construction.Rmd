...
png("~/Desktop/F2_paper/rf.png", width=8, height=8, units="in", res=300)
plot.rf(LG.f2.madmapper.after.crossover, alternate.chrid = T) # the old genetic map 
dev.off()
...
ggsave(p.genetic_vs_physical, filename = "~/F2/output/p.genetic_vs_physical.png", height = 10, width = 10) 
``` 
