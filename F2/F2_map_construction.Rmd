...
plot.map(LG.f2.madmapper, alternate.chrid = T) # the old genetic map
plot.map(LG.f2.madmapper.before.crossover,LG.f2.madmapper, alternate.chrid = T) # genetic map comparison
