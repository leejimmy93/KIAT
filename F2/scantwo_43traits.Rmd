...
# QTL result 
load("~/F2/output/scantwo/scantwo.imp.Rdata")
...
qtlm.Erucic <- makeqtl(LG.f2.after.crossover,chr=c(8, 13),pos=c(73, 30), what = "prob") # Ruijuan: QTL with interactions
...
qtl.fit.Erucic <- fitqtl(cross=LG.f2.after.crossover,qtl=qtlm.Erucic,formula = y ~ Q1 + Q2, get.ests=T, method = "hk")
