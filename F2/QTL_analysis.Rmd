...
# 
qtl_plot(input = rbind(data.frame(cim.qtl[["Behenic_acid"]], method = "cim"), 
                       data.frame(scanone.imp[["Behenic_acid"]], method = "scanone")),
         chrs = c(8), 
         # lod = cim.perm[[1]], 
         rug = TRUE)

# refine and save figure 
# to do, find SNPs underline ... 
```
