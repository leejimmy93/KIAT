...
```{r}
load("~/Desktop/Brassica_project/KIAT_RNA_seq/F2/data/QTL_analysis/LG.f2.after.crossover.43traits.Rdata")
LG.f2.after.crossover$pheno %>% dim() # 166 43 

colnames(LG.f2.after.crossover$pheno)

LG.f2.after.crossover$pheno$Behenic_acid %>% hist()
# Behenic & cis_11_Eicosenoic_acid & Palmitoliec 
...
>>>>>>> 8644c2abce85914d86a71f3675c38f88d3db6a2f
```
