...
# get new phenotype, difference between flower time and bolting time, that is the time to take flower after bolting
LG.f2.after.crossover$pheno[,41]
LG.f2.after.crossover$pheno[,42]
...
pwalk(list(paths, plots), ggsave, path = "~/Desktop/Brassica_project/KIAT_RNA_seq/F2/output/figure /", width = 15, height = 7)
``` 
...
# /share/malooflab/Ruijuan/KIAT_cabernet/F2/scantwo.R, took several days to finish

# scp result to whitney
load("~/F2/output/QTL_analysis/scantwo/scantwo.imp.Rdata")
plot(scantwo.imp[[1]], chr=2) 
scantwo.imp 
