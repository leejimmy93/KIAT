...
scanone.perm.imp <- scanone(LG.f2.after.crossover,method="imp",n.perm=1000) # takes 6 mins (already run 1000 times of mapping after permutating pheno data?) 

# look at summary of our permutation 
summary(scanone.perm.imp) #shows the 90th and 95th percentile of LOD scores in randomized data 
