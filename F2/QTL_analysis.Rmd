...
# permutation result for Erucic acid and Oleic acid 
# load data 
...
qtlm.Erucic <- makeqtl(LG.f2.after.crossover,chr=c("A08", "C03"),pos=c(72.3, 34.9)) # Ruijuan: QTL with interactions
...
qtlm.Oleic <- makeqtl(LG.f2.after.crossover,chr=c("A08", "C03"),pos=c(72.3, 29.2))  
qtlm.Oleic
