...
#   }) # takes 40 mins to finish
# )
# sfStop()  #### how to do permutation for eQTL 

system.time(scanone_imp_tot <- scanone(LG.f2.after.crossover, pheno.col = 1:4943, 
...
### load data 
```{r}
LG.f2 <- read.cross("mm", file = "~/F2/data/QTL_analysis/F2_geno_for_one_map_final_all_expressed_gene.txt", mapfile = "~/F2/data/QTL_analysis/LG.f2.madmapper.map")
save(LG.f2, file = "~/F2/output/QTL_analysis/LG.f2.fatty_acid_lipid.Rdata")
