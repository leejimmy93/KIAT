...
plot(eQTL_result[[9]]$BnaA08g11130D,bandcol="gray90", main="BnaA08g11130D") # looks good
abline(h=lod.thres,lty=2) 

plot(eQTL_result[[7]]$BnaC03g65980D,bandcol="gray90", main="BnaC03g65980D") # looks good
abline(h=lod.thres,lty=2) 
...
cis_trans_result_2$cis_trans <- ifelse(cis_trans_result_2$gene_chrom == cis_trans_result_2$snp_chrom, "cis", "trans")
sum(cis_trans_result_2$cis_trans == "cis") # 492708 
...
length(unique(cis_trans_result_2[cis_trans_result_2$cis_trans == "cis",]$gene_ID)) # 11118 

length(unique(cis_trans_result_2[cis_trans_result_2$cis_trans == "trans",]$gene_ID)) # 13295   

length(unique(cis_trans_result_2$gene_ID))
``` 
