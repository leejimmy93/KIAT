...
cis_candidate_4 %>% 
  ...
  dplyr::select(-(cis_trans:loci_end))

dim(cis_trans_result_final) # 728717     11 

cis_trans_result_final[is.na(cis_trans_result_final$cis_trans_2),][,"cis_trans_2"] <- rep("trans", sum(is.na(cis_trans_result_final$cis_trans_2)))
sum(cis_trans_result_final$cis_trans_2 == "cis") # 75225 
sum(cis_trans_result_final$cis_trans_2 == "trans") # 653492 

length(unique(cis_trans_result_final[cis_trans_result_final$cis_trans_2 == "cis",]$gene_ID)) # 7514
length(unique(cis_trans_result_final[cis_trans_result_final$cis_trans_2 == "trans",]$gene_ID)) # 20929 
...
cis_trans_result_final %>% dim() # 728717 

####### 
cis_trans_result_final[cis_trans_result_final$cis_trans == "cis",]$gene_ID %>% unique() %>% length() 
