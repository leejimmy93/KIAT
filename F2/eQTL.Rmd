...
scanone.perm.imp <- 
  sfLapply(seq_along(LG.f2.after.crossover$pheno), function(trait){
    ...
    tmp <-scanone(LG.f2.after.crossover,pheno.col = trait, method="imp",n.perm=1000, n.cluster = 12, verbose = T, chr = 01)
...
plot(scanone.imp.BnaC03g67820D,bandcol="gray90", main="BnaC03g67820D")
