...
<<<<<<< HEAD
png("~/F2/output/QTL_analysis/figure/P.genetic_vs_physical.png", width=20, height=15, units="in", res=300)
par(mfrow=c(4,5))  
=======
# png("~/F2/output/QTL_analysis/figure/P.genetic_vs_physical.png", width=20, height=15, units="in", res=300)
# par(mfrow=c(4,5)) 
...
>>>>>>> 423d3b2ff8bded12b340c9c53704992d4222e541
...
for (i in unique(map_geno$genetic_chr)){
  plot(map_geno[map_geno$genetic_chr == i,]$genetic_pos, map_geno[map_geno$genetic_chr == i,]$physical_pos, 
       xlab = "genetic pos", ylab = "physical pos", main = i, type = "p") 
}
