...
par(mfrow=c(4,3), mai = c(0.4, 0.4, 0.4, 0.4), ps = 8, cex = 1, cex.main = 1, cex.axis = 0.8, tcl = -0.3)
...
setEPS()
postscript(file = "~/Desktop/F2_paper/trait_oil.eps", width=6.9, height=7.9)
par(mfrow=c(6,4), mai = c(0.4, 0.4, 0.4, 0.4), ps = 8, cex = 1, cex.main = 1, cex.axis = 0.8, tcl = -0.3)   

for (i in colnames(phefile_oil)) {
  if(i == "Erucic_acid" |i == "Oleic_acid"){
    hist(phefile_oil[,i], breaks = 30, col = "grey", border = "black", xlab = "", ylab = "", main = i, xlim = c(min(phefile_oil[,i]), 65))
  } else { 
  hist(phefile_oil[,i], breaks = 30, col = "grey", border = "black", xlab = "", ylab = "", main = i)}
...
setEPS()
postscript(file = "~/Desktop/F2_paper/trait_cor_heatmap.eps", width=6.7, height=7.9)
par(mar = c(3, 3, 3, 3), ps = 8, cex = 0.8, cex.main = 0.8, cex.axis = 0.8, tcl = -0.3)
