...
pheno.parent.oil[32,] <- c("days_to_flower", "Da-Ae", "166")
pheno.parent.oil[33,] <- c("days_to_flower", "Da-Ol-1", "105") 
pheno.parent.oil[34,] <- c("days_to_bolt", "Da-Ae", "127")
pheno.parent.oil[35,] <- c("days_to_bolt", "Da-Ol-1", "97")
pheno.parent.oil[36,] <- c("bolting_to_flowering", "Da-Ae", "39")
pheno.parent.oil[37,] <- c("bolting_to_flowering", "Da-Ol-1", "1")
pheno.parent.oil[38,] <- c("plant_weight_2016_05_13", "Da-Ae", "127")
pheno.parent.oil[39,] <- c("plant_weight_2016_05_13", "Da-Ol-1", "97")
pheno.parent.oil[40,] <- c("root_weight_2016_05_13", "Da-Ae", "39")
pheno.parent.oil[41,] <- c("root_weight_2016_05_13", "Da-Ol-1", "1")

test <- test[,c(18, 19)]
rownames(test) <- c("Da-Ol-1", "Da_Ae", "F1_136", "F1_137")


phefile_oil <- phefile[,grep("oil|acid|seeds|rate|flower|bolt|root|weight", colnames(phefile))]  
