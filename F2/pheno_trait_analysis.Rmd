...
# oil trait 
load("~/Desktop/Brassica_project/KIAT_RNA_seq/F2/heritability/pheno.parent.H2.Rdata")
pheno.parent.oil <- 
pheno.parent.H2 %>% 
  dplyr::select(-class) 

pheno.parent.oil <- pheno.parent.oil[,c("genotype", "year", "PHENOTYPE", "value")]
colnames(pheno.parent.oil)[2] <- "rep_ID"
pheno.parent.oil$PHENOTYPE 
...
summary(lme) 
var <- as.data.frame(VarCorr(lme)) 
var$vcov[2] # residual is the environmental effect   
