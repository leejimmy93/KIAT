...
png(filename = "~/Desktop/F2_paper/trait_oil.png",width=12, height=7, units="in", res=300)
par(mfrow=c(5,5), mai = c(0.4, 0.4, 0.4, 0.2)) 
...
png(filename = "~/Desktop/F2_paper/trait_cor_heatmap.png",width=8, height=8, units="in", res=300)
par(mar = c(3, 3, 3, 3))
