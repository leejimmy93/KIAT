...
trait_cor <- round(cor(phefile.all, use = "pairwise.complete.obs"), digits = 2) 
# show pair of traits whose correlation are above 0.5 
high.cor.pair(trait_cor, threshold = 0.5)
...
png(filename = "~/Desktop/F2_paper/trait_cor_heatmap.png",width=12, height=9, units="in", res=300)
par(mar = c(3, 3, 3, 3))
