...
mark.f2.C05 <- make.seq(twopts.f2.LOD3_rf0.5, 2601:2643)
...
save(LG.f2.ord.C05, file = "/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/ruijuanli/F2/output/missing_rate_0.15/LG.f2.ord.C05.Rdata")
