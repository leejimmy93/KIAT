...
=======
coefficients.fit$type <- factor(rownames(coefficients.fit), levels = c("ref.vs.three.quarter", "ref.vs.half", "ref.vs.one.quarter", "ref.vs.rep2","ref.vs.rep1"),labels=c("ref.vs.three.quarter", "ref.vs.half", "ref.vs.one.quarter","ref.vs.two.reps","ref.vs.one.rep"))
>>>>>>> f9224a8735952539a795b55f8a700dee155e1ad6
